...
(function(html) {
    ...
    * ------------------------------------------------------ */
    const ssOffCanvas = function() {
        ...
        const menuclose1 = document.querySelector('.menuclose1');
        const menuclose2 = document.querySelector('.menuclose2');
        const menuclose3 = document.querySelector('.menuclose3');
